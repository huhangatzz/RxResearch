...
private enum AssociatedKeys {
    static var emptyDataSetSource: UInt8 = 0
    static var emptyDataSetDelegate: UInt8 = 0
    static var emptyDataSetView: UInt8 = 0
    static var configureEmptyDataSetView: UInt8 = 0
}
...
extension UIScrollView {
    ...
    private var configureEmptyDataSetView: ((EmptyDataSetView) -> Void)? {
        get {
            return objc_getAssociatedObject(self, &AssociatedKeys.configureEmptyDataSetView) as? (EmptyDataSetView) -> Void
        }
        set {
            objc_setAssociatedObject(self, &AssociatedKeys.configureEmptyDataSetView, newValue, .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
    ...
    public var emptyDataSetSource: EmptyDataSetSource? {
        get {
            let container = objc_getAssociatedObject(self, &AssociatedKeys.emptyDataSetSource) as? WeakObjectContainer
        ...
        set {
            ...
            objc_setAssociatedObject(self, &AssociatedKeys.emptyDataSetSource, WeakObjectContainer(with: newValue), .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
            UIScrollView.swizzleReloadData
            if self is UITableView {
                UIScrollView.swizzleEndUpdates
            }
    ...
    public var emptyDataSetDelegate: EmptyDataSetDelegate? {
        ...
        set {
            ...
            objc_setAssociatedObject(self, &AssociatedKeys.emptyDataSetDelegate, WeakObjectContainer(with: newValue), .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
        }
    }
    
    public var isEmptyDataSetVisible: Bool {
        if let view = objc_getAssociatedObject(self, &AssociatedKeys.emptyDataSetView) as? EmptyDataSetView {
    ...
    private var emptyDataSetView: EmptyDataSetView? {
        get {
            if let view = objc_getAssociatedObject(self, &AssociatedKeys.emptyDataSetView) as? EmptyDataSetView {
                ...
                objc_setAssociatedObject(self, &AssociatedKeys.emptyDataSetView, view, .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
                
                return view
            }
        }
        set {
            objc_setAssociatedObject(self, &AssociatedKeys.emptyDataSetView, newValue, .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
        }
    }

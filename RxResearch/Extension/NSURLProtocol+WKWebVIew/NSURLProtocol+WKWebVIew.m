...
FOUNDATION_STATIC_INLINE Class ContextControllerClass(void) {
    static Class cls;
    if (!cls) {
...
FOUNDATION_STATIC_INLINE SEL RegisterSchemeSelector(void) {
    return NSSelectorFromString(@"registerSchemeForCustomProtocol:");
}

FOUNDATION_STATIC_INLINE SEL UnregisterSchemeSelector(void) {
